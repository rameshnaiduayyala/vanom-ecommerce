...
export async function brandRoutes(fastify) {
  ...
  fastify.get("/brands/:id", { schema: { params: idParams } }, controller.getById);
  ...
  fastify.delete("/brands/:id", { schema: { params: idParams }, preHandler: superadminGuard }, controller.remove);
}
