const INITIAL_CATEGORIES = [
  { id: "cat-combos", name: "Value Combos", slug: "combos", count: 28, description: "Curated super saver combo packs and bundles with up to 40% discount." },
...
const INITIAL_PRODUCTS = [
  // ─── CURATED VALUE COMBOS ───
  {
    ...
    badge: "BEST VALUE",
    isCombo: true,
    specs: "Kadha Sips (30 Sachets) + Raw Forest Honey (500g)",
    image: "https://images.unsplash.com/photo-1544787219-7f47ccb76574?auto=format&fit=crop&w=800&q=80",
    description: "Ultimate seasonal cold defense and immunity combo pairing authentic Ayurvedic herbal sips with 100% raw unheated forest honey.",
    itemsIncluded: [
      "Kadha Sips for Cold & Cough (30 Sachets)",
      "Pure Raw Organic Forest Honey (500g)",
    ],
    pricing: {
      IN: { currency: "INR", symbol: "₹", retailPrice: 699, mrp: 999 },
      US: { currency: "USD", symbol: "$", retailPrice: 16.99, mrp: 24.99 },
      CA: { currency: "CAD", symbol: "CA$", retailPrice: 22.99, mrp: 32.99 },
    },
  },
  {
    ...
    badge: "TOP SELLER",
    isCombo: true,
    specs: "Cold Pressed Olive Oil (1L) + Basmati Rice (5KG) + Pink Salt (1KG)",
    image: "https://images.unsplash.com/photo-1474979266404-7eaacbcd87c5?auto=format&fit=crop&w=800&q=80",
    description: "High-grade organic culinary trio featuring cold-pressed extra virgin olive oil, 2-year aged Himalayan basmati rice, and mineral-rich pink salt.",
    itemsIncluded: [
      "Cold Pressed Extra Virgin Olive Oil (1 Litre)",
      "Royal Heritage Aged Basmati Rice (5 KG)",
      "Pure Organic Himalayan Pink Salt (1 KG)",
    ],
    pricing: {
      IN: { currency: "INR", symbol: "₹", retailPrice: 1399, mrp: 2149 },
      US: { currency: "USD", symbol: "$", retailPrice: 29.99, mrp: 46.99 },
      CA: { currency: "CAD", symbol: "CA$", retailPrice: 39.99, mrp: 59.99 },
    },
  },
  {
    id: "combo-superfood-energy",
    name: "Morning Energy Superfood Duo",
    slug: "combo-superfood-energy",
    sku: "CMB-SUPERFOOD-03",
    category: "Value Combos",
    categoryId: "cat-combos",
    brand: "ZenLeaf",
    rating: 4.95,
    ...
    badge: "ORGANIC PACK",
    isCombo: true,
    specs: "Matcha Tea (100g) + Raw Almonds (500g) + Chia Seeds (400g)",
    image: "https://images.unsplash.com/photo-1536256263959-770b48d82b0a?auto=format&fit=crop&w=800&q=80",
    description: "Start your morning with clean, calm focus and nutrient density. First harvest Japanese ceremonial matcha paired with supreme California almonds and raw chia seeds.",
    itemsIncluded: [
      "Ceremonial Grade Matcha Green Tea (100g)",
      "California Whole Raw Almonds (500g)",
      "Organic Raw Chia Seeds (400g)",
    ],
    pricing: {
      IN: { currency: "INR", symbol: "₹", retailPrice: 1199, mrp: 1948 },
      US: { currency: "USD", symbol: "$", retailPrice: 24.99, mrp: 39.99 },
      CA: { currency: "CAD", symbol: "CA$", retailPrice: 32.99, mrp: 52.99 },
    },
  },
  // ─── GROCERIES & ORGANIC ESSENTIALS ───
  {
    id: "organic-kashmiri-saffron",
    name: "Pure Organic Kashmiri Mongra Saffron 1g",
    ...
    discount: 23,
    badge: "Bestseller",
    specs: "Grade A1 Super Mongra | Natural Aroma | 100% Pure Stigmas",
    bgGradient: "from-[#FAF3DF] via-[#F8ECD1] to-[#F3E2BD]",
    image: "https://images.unsplash.com/photo-1596040033229-a9821ebd058d?auto=format&fit=crop&w=800&q=80",
    gallery: [
      "https://images.unsplash.com/photo-1596040033229-a9821ebd058d?auto=format&fit=crop&w=800&q=80",
    ],
    description: "Authentic deep crimson all-red saffron stigmas hand-picked from the Pampore valley of Kashmir. Rich in crocin, safranal, and natural floral aroma.",
    stock: 250,
    highlights: [
      { label: "Grade", value: "Grade 1 Super Mongra" },
      { label: "Purity", value: "100% Certified Pure" },
      { label: "Origin", value: "Pampore, Kashmir" },
      { label: "Weight", value: "1 Gram Airtight Acrylic Jar" },
    ],
    features: [
      "Deep crimson color with intense lingering aroma",
      "Perfect for biryanis, sweets, saffron tea, and golden milk",
      "Tested for ISO 3632 Category I purity standards",
    ],
    specifications: {
      Brand: "KashmirValley",
    ...
    pricing: {
      IN: { currency: "INR", symbol: "₹", retailPrice: 499, mrp: 650 },
      US: { currency: "USD", symbol: "$", retailPrice: 9.99, mrp: 14.00 },
      CA: { currency: "CAD", symbol: "CA$", retailPrice: 12.99, mrp: 17.50 },
    },
  },
  {
    id: "pure-a2-cow-desi-ghee",
    name: "Pure Organic A2 Bilona Cow Desi Ghee 500ml",
    ...
    discount: 25,
    badge: "Bestseller",
    specs: "Traditional Vedic Bilona Churned | Grass-Fed Gir Cows",
    ...
    description: "Handcrafted traditional A2 Cow Ghee churned from curd (Bilona method) of grass-fed indigenous cows. Danedar golden texture with rich nutty aroma.",
    stock: 180,
    highlights: [
      { label: "Method", value: "Traditional Vedic Bilona" },
      { label: "Source", value: "Grass-Fed Gir Cow Milk" },
      { label: "Volume", value: "500ml Glass Jar" },
    ],
    features: [
      "Rich in fat-soluble vitamins A, D, E, K and butyric acid",
      "Grainy golden texture with irresistible aroma",
      "Free from preservatives, hormones, and artificial colors",
    ],
    specifications: {
      Brand: "VedicRoots",
      "Country of Origin": "India",
    ...
    pricing: {
      IN: { currency: "INR", symbol: "₹", retailPrice: 749, mrp: 999 },
      US: { currency: "USD", symbol: "$", retailPrice: 16.99, mrp: 22.50 },
      CA: { currency: "CAD", symbol: "CA$", retailPrice: 21.99, mrp: 28.99 },
    },
  },
  {
...
const STORAGE_KEYS = {
  PRODUCTS: "vanom_mock_products_v7",
  CATEGORIES: "vanom_mock_categories_v7",
};
