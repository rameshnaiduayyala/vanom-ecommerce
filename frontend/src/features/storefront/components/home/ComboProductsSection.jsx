    ...
    <section className={`py-10 sm:py-14 w-full max-w-full overflow-hidden ${className}`}>
      <div className="max-w-[1440px] mx-auto px-4 sm:px-8 w-full min-w-0">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-3 sm:gap-4 mb-8">
          <div>
            <div className="inline-flex items-center gap-1.5 bg-[#3e8e45]/15 text-[#204B38] text-[11px] font-black uppercase tracking-wider px-3 py-1 rounded-full mb-2 border border-[#3e8e45]/25 shadow-2xs">
              <BadgePercent className="w-3.5 h-3.5 text-[#3e8e45]" />
              Super Saver Bundles
            </div>
          ...
          <Link
            ...
            className="flex items-center gap-1.5 text-xs sm:text-sm font-black text-[#3e8e45] hover:text-[#204B38] transition-colors whitespace-nowrap shrink-0 group"
          >
