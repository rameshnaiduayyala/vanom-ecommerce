...
export function HeroSlider({ products = [] }) {
  ...
  return (
    ...
    >
      ...
      {/* Main Hero Content */}
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-8 lg:px-12 pt-8 sm:pt-16 pb-20 sm:pb-24 lg:py-20">
        <div className="grid lg:grid-cols-12 gap-8 sm:gap-12 lg:gap-16 items-center">
          ...
          <div className="lg:col-span-7 max-w-2xl">
            <AnimatePresence mode="wait">
              ...
              >
                {/* Eyebrow Pill */}
                <div className="inline-flex items-center gap-2 px-3 py-1 sm:px-3.5 sm:py-1.5 rounded-full bg-[#0B4F32] border border-[#16A34A]/40 text-[#4ADE80] font-bold text-[10px] sm:text-xs uppercase tracking-wider">
                ...
                <h1
                  ...
                  style={{ fontSize: "clamp(1.9rem, 4.8vw, 3.8rem)" }}
                >
                  <span className="block text-white">
                    {s.titleLine1 || s.title}
                  </span>
                  <span className="block text-[#4ADE80] mt-1 sm:mt-1.5">
                    {s.titleLine2 || "Across Every Global Market"}
                  </span>
                </h1>

                {/* Subtitle */}
                <p className="text-xs sm:text-[15px] lg:text-base text-emerald-100/80 leading-relaxed max-w-xl font-normal">
                ...
                <div className="flex flex-wrap items-center gap-2.5 sm:gap-3.5 pt-1">
                  <Link
                    to={ROUTES.PRODUCTS}
                    className="inline-flex items-center justify-center gap-2 px-5 sm:px-7 py-3 sm:py-3.5 rounded-xl text-xs sm:text-sm font-semibold bg-[#00875A] hover:bg-[#00744D] text-white shadow-lg shadow-[#00875A]/25 transition-all cursor-pointer"
                  >
                  ...
                  <Link
                    ...
                    className="inline-flex items-center justify-center gap-2 px-5 sm:px-6 py-3 sm:py-3.5 rounded-xl text-xs sm:text-sm font-medium text-white bg-[#0B472E]/70 hover:bg-[#0B472E] border border-white/20 transition-all cursor-pointer"
                  >
                ...
                {/* Stats */}
                <div className="grid grid-cols-3 gap-2 sm:gap-8 pt-4 sm:pt-6 border-t border-emerald-800/50">
                  {s.stats.map((st, i) => (
                    <div key={i}>
                      <div className="text-lg sm:text-2xl font-black text-white tracking-tight">
                        {st.value}
                      </div>
                      <div className="text-[10px] sm:text-xs text-emerald-200/70 font-medium mt-0.5">
                        {st.label}
                      </div>
                    </div>
                  ))}
          ...
          <div className="lg:col-span-5 flex justify-center lg:justify-end">
            <AnimatePresence mode="wait">
              ...
              >
                ...
                <div className="relative rounded-3xl sm:rounded-[2.5rem] p-2 sm:p-3 bg-white shadow-2xl overflow-hidden">
                  <div className="relative h-[260px] sm:h-[360px] lg:h-[420px] rounded-2xl sm:rounded-[2rem] overflow-hidden">
                    <img
                    ...
                    <div className="absolute bottom-2.5 left-2.5 right-2.5 sm:bottom-3 sm:left-3 sm:right-3 p-3 sm:p-4 bg-[#0B3B24]/95 backdrop-blur-md rounded-xl sm:rounded-2xl border border-white/10 shadow-xl flex items-center justify-between gap-2 sm:gap-3">
                      <div className="min-w-0">
                        <span className="block text-[9px] sm:text-[10px] font-bold tracking-[0.12em] text-[#4ADE80] uppercase mb-0.5">
                          FEATURED COLLECTION
                        </span>
                      ...
                      <span className="bg-white text-[#0B3B24] font-extrabold text-[9px] sm:text-[10px] px-2 py-0.5 sm:px-2.5 sm:py-1 rounded-md uppercase tracking-wider whitespace-nowrap shadow-sm shrink-0">
                        VERIFIED
                      </span>
                    </div>
                  </div>
